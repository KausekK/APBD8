...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<Emp> result = 
                    Emps.Where(e=>e.Salary == (Emps.Max(e=>e.Salary)));
            return result;
        }
        ...
        {
            bool result = 
                    Emps.Where(e=>e.Job.Equals("Backend programmer")).Count() > 0;
            return result;
        }
        ...
        {
            Emp result = 
                    Emps.Where(e=>e.Job.Equals("Frontend programmer")).First();
            return result;
        }
        ...
        {
            IEnumerable<Emp> result =  Emps.GetEmps();
            return result;
    ...
    public static class CustomExtensionMethods
    {
        public static IEnumerable<Emp> GetEmps(this IEnumerable<Emp> Emps)
        {
            IEnumerable<Emp> result = Emps
                .Where(e=>Emps.Any(f=>f.Mgr == e)).OrderBy(e =>e.Ename).ThenByDescending(e=>e.Salary);
            return result;
        }
    }
}